 ...
 */
class MaxMindCountryProvider extends AbstractProvider implements ProviderInterface
{
    /**
     * @var string
     */
    ...
    public function getGeocodedData($address)
    {
        ...
        if (!filter_var($address, FILTER_VALIDATE_IP)) {
            throw new UnsupportedException('The MaxMindCountryProvider does not support street addresses.');
        }
    ...
    {
        throw new UnsupportedException('The MaxMindCountryProvider is not able to do reverse geocoding.');
    }
