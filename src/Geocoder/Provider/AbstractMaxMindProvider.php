 ...
 */
abstract class AbstractMaxMindProvider extends AbstractProvider implements ProviderInterface
{
    /**
     * @var string
     */
     ...
     * @return null|string
     */
    protected function chunkValueOrNull($chunk)
    {
        if (in_array($chunk, array('(null)', ''))) {
            return null;
        }
