...
class MaxMindCityIspOrgProvider extends AbstractProvider implements ProviderInterface
{
    ...
    public function getGeocodedData($address)
    {
        ...
        if (!filter_var($address, FILTER_VALIDATE_IP)) {
            throw new UnsupportedException('The MaxMindCityIspOrgProvider does not support street addresses.');
        }

        // This API does not support IPv6
        if (filter_var($address, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6)) {
            throw new UnsupportedException('The MaxMindCityIspOrgProvider does not support IPv6 addresses.');
        }
    ...
    {
        throw new UnsupportedException('The MaxMindCityIspOrgProvider is not able to do reverse geocoding.');
    }
