...
final class LocationIQ extends AbstractHttpProvider implements Provider
{
    ...
    {
        return self::BASE_API_URL.'/search.php?q=%s&format=xml&addressdetails=1&normalizecity=1&limit=%d&key='.$this->apiKey;
    }

    private function getReverseEndpointUrl(): string
    {
        return self::BASE_API_URL.'/reverse.php?format=xml&lat=%F&lon=%F&addressdetails=1&normalizecity=1&zoom=%d&key='.$this->apiKey;
    }
