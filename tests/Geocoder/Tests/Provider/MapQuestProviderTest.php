...
class MapQuestProviderTest extends TestCase
{
    ...
    public function testGetGeocodedDataWithRealAddress()
    {
        ...
        $this->assertCount(1, $results); // the provider returns only one result
    ...
    public function testGetReversedDataWithRealCoordinates()
    {
        ...
        $this->assertTrue(is_array($result));
        $this->assertCount(1, $result); // the provider returns only one result
    ...
    public function testGetGeocodedDataWithCity()
    {
        ...
        $this->assertTrue(is_array($results));
        $this->assertCount(MapQuestProvider::MAX_RESULTS, $results);
