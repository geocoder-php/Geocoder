...
class GoogleMapsBusinessTest extends TestCase
{
    ...
    public function testBuildQueryWithNoPrivateKey()
    {
        ...
        $provider = new GoogleMapsBusiness($this->getMockAdapter($this->never()), $this->testClientId);
        $query    = 'http://maps.google.com/maps/api/geocode/json?address=blah';
    ...
    public function testSignQuery()
    {
        ...
        $query = 'http://maps.google.com/maps/api/geocode/json?address=10%20avenue%20Gambetta%2C%20Paris%2C%20France';
     ...
     * @expectedExceptionMessage Invalid client ID / API Key https://maps.google.com/maps/api/geocode/json?address=Columbia%20University&client=foo&signature=9dJq1hPF7_iwafUpnqXUqEkP0gY=
     */
    ...
    /**
     * @expectedException \Geocoder\Exception\InvalidCredentials
     * @expectedExceptionMessage Invalid client ID / API Key http://maps.google.com/maps/api/geocode/json?address=Columbia%20University&client=foo&signature=9dJq1hPF7_iwafUpnqXUqEkP0gY=
     */
