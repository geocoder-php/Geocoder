...
* `ZendHttpAdapter` for [Zend Http Client](http://framework.zend.com/manual/2.0/en/modules/zend.http.html).
...
To run unit tests, you'll need a set of dependencies you can install by running the `composer` script:
