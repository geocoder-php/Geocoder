...
[Azure Maps](https://github.com/max-langerman/azure-maps-provider) | `max-langerman/azure-maps-provider` | address, reverse <br> [Website](https://docs.microsoft.com/en-us/azure/azure-maps/tutorial-search-location) |  <br>
