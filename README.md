...
[Azure Maps](https://github.com/geocoder-php/azure-maps-provider) | `geocoder-php/azure-maps-provider` | address, reverse <br> [Website](https://docs.microsoft.com/en-us/azure/azure-maps/tutorial-search-location) |  <br>
